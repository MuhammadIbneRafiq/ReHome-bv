        ...
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="space-y-4">
                <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold">1. Affordable & Transparent Pricing</h2>
                ...
                <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold">2. Eco-Friendly & Sustainable</h2>
                ...
                <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold">3. Reliable & Professional Team</h2>
                ...
                <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold">4. Convenience at Your Fingertips</h2>
                ...
                <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold">5. Serving Expats, Students & Locals</h2>
                ...
                <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold">6. Social Impact & Community Support</h2>
